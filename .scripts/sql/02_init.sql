...
INSERT INTO `dim_postal_towns`
    (`routing_key`, `name`, `county`)
VALUES
    ('A92', 'Ardee', 'Louth'),
    ('Y14', 'Arklow', 'Wicklow'),
    ('A84', 'Ashbourne', 'Meath'),
    ...
    ('P24', 'Cobh', 'Cork'),
    ('H16', 'Cootehill', 'Cavan'),
    ('T12', 'Cork (centre)', 'Cork'),
    ('T12', 'Cork (southside)', 'Cork'),
    ('T12', 'Passage West', 'Cork'),
    ('T12', 'Cork Airport', 'Cork'),
    ...
    ('P17', 'Kinsale', 'Cork'),
    ('A92', 'Laytown', 'Meath'),
    ('A92', 'Bettystown', 'Meath'),
    ('A92', 'Mornington', 'Meath'),
    ('A92', 'Donacarney', 'Meath'),
